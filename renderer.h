...
typedef struct {
	hmm_vec3 eye, look, up;
} CameraInfo;

void start_render(CameraInfo cam) {
	...
	hmm_vec3 look_point = HMM_AddVec3(cam.eye, cam.look);
    hmm_mat4 view = HMM_LookAt(cam.eye, look_point, cam.up);

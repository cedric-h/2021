...
fn buildSokol(b: *bld.Builder) *bld.LibExeObjStep {
    ...
    if (lib.target.isDarwin()) {
        ...
        lib.addCSourceFile("sokol-zig/src/sokol/sokol.c", &[_][]const u8{});
...
pub fn build(b: *bld.Builder) void {
    ...
    const e = b.addExecutable("2021", "src/main.zig");
    e.linkLibrary(sokol);
    e.setBuildMode(b.standardReleaseOptions());
    e.addPackagePath("sokol", "sokol-zig/src/sokol/sokol.zig");
    e.addPackagePath("math.zig", "sokol-zig/src/examples/math.zig");
    e.install();
    b.step("run", "Run").dependOn(&e.run().step);
}
